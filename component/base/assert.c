...
//    DbgOutString( "Test-now.\r\n" );    
    va_start( vl, lpszFormat );
//    DbgOutString( "Test-begin\r\n" );
//    OutputNumHex(  (long)vl, 0 );
//    DbgOutString( "Testkkk\r\n" );        
//    OutputNumHex( (long)lpszFormat, 0 );    
//    DbgOutString( "Test-end\r\n" );
    
//    DbgOutString( "lllllllTest-now.\r\n" );
