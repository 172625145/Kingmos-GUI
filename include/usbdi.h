...
#define ERROR_OUTOFMEMORY  1001
#define ERROR_BUSY         1002
...
typedef VOID (* LPGET_USBD_VERSION)(UINT * lpdwMajorVersion,
                                    UINT * lpdwMinorVersion);
...
//Helper commands
typedef BOOL (* LPTRANSLATE_STRING_DESCR)(LPCUSB_STRING_DESCRIPTOR, LPSTR,
                                          DWORD);
