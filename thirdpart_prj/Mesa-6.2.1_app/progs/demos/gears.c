...
int Run_Mesa_Gears( )
{
	...
	glutInitWindowPosition(WORK_AREA_STARTX, WORK_AREA_STARTY);
...
#endif
{
	...
	Register_Mesa_Gears_Class( hInstance );	// ×¢²á´°¿Ú
	hWnd = CreateWindowEx(WS_EX_NOMOVE|WS_EX_CLOSEBOX,classMESA_GEARS, "Gears", WS_VISIBLE|WS_POPUP|WS_CAPTION,
			WORK_AREA_STARTX, WORK_AREA_STARTY,
			WORK_AREA_WIDTH,
			WORK_AREA_HEIGHT,
			0,0,hInstance,0 );
	ShowWindow(hWnd, TRUE); // ÏÔÊ¾´°¿Ú
