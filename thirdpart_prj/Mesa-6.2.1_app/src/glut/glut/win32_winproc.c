...
//#include <mmsystem.h>  /* Win32 Multimedia API header. *///LiuJUN
#include <emmsys.h>		// Added By Liujun 
#endif

#include "gl\mlg_glwin.h"
#include "gl\mlg_glcmd.h"
