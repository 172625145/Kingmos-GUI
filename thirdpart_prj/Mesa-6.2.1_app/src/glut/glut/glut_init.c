...
#ifdef _WIN32
void (*__glutExitFunc)(int retval) = NULL;
#endif
...
__glutOpenWin32Connection(char* display)
{
  ...
  if(!wc.hIcon)
    wc.hIcon = (HICON)LoadIcon(NULL, (LPCTSTR)IDI_WINLOGO);
...
#ifdef _WIN32
void GLUTAPIENTRY 
__glutInitWithExit(int *argcp, char **argv, void (*exitfunc)(int))
{
