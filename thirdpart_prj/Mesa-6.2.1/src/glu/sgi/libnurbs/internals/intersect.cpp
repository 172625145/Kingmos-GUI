...
Subdivider::arc_split( Arc_ptr jarc, int param, REAL value, int dir )
{
    ...
    case INTERSECT_VERTEX: {
	    jarc1 = new(arcpool) GL_Arc( jarc, new( pwlarcpool) PwlArc( maxvertex-loc[1], &v[loc[1]] ) );
    ...
    case INTERSECT_EDGE: {
	    ...
	    if (maxvertex == 2) {
		jarc1 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( 2, newjunk+1 ) );
		jarc->pwlArc->npts = 2;
		...
		jarc1 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( 2, newjunk ) );
		jarc2 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( 2, newjunk+1 ) );
		...
		jarc1 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( 2, newjunk ) );
		jarc2 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( 2, newjunk+1 ) );
		jarc3 = new(arcpool) GL_Arc( jarc, new(pwlarcpool) PwlArc( maxvertex-i, v+i ) );
