...
//#include "gl\mlg_glstruct.h"	// Inserted By Liujun 
ArcSorter::ArcSorter(Subdivider &s) : Sorter( sizeof( GL_Arc ** ) ), subdivider(s)
{
}
...
void
ArcSorter::qsort( GL_Arc **a, int n )
{
...
{
    GL_Arc **jarc1 = (GL_Arc **) i;
    GL_Arc **jarc2 = (GL_Arc **) j;
    GL_Arc *tmp = *jarc1;
    *jarc1 = *jarc2;
    *jarc2 = tmp;
}	
