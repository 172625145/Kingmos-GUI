...
/*#define OTV_NEST1( x )  OTV_NEST1_( x )   //lilin remove */
#define OTV_NEST1( x )
...
/*#define OTV_NEST2( x, y )  OTV_NEST2_( x, y )  //lilin remove */
...
/*#define OTV_NEST3( x, y, z )  OTV_NEST3_( x, y, z )  //lilin remove */
...
#define OTV_TRACE( s )                                     \
  ...
  /* use preprocessor's argument prescan to expand one argument into two */
#define OTV_NEST1( x )  // OTV_NEST1_( x ) by lilin
#define OTV_NEST1_( func0, name0 )        \
          FT_BEGIN_STMNT                  \
            valid->nesting_level = 0;     \
            valid->func[0]       = func0; \
  ...
  /* use preprocessor's argument prescan to expand two arguments into four */
#define OTV_NEST2( x, y )  // OTV_NEST2_( x, y ) by lilin
#define OTV_NEST2_( func0, name0, func1, name1 ) \
          FT_BEGIN_STMNT                         \
            valid->nesting_level = 0;            \
            valid->func[0]       = func0;        \
  ...
  /* use preprocessor's argument prescan to expand three arguments into six */
#define OTV_NEST3( x, y, z )  // OTV_NEST3_( x, y, z ) by lilin
#define OTV_NEST3_( func0, name0, func1, name1, func2, name2 ) \
          FT_BEGIN_STMNT                                       \
            valid->nesting_level = 0;                          \
            valid->func[0]       = func0;                      \
