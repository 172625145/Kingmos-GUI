...
static int SYSFont16_WordMask( HANDLE, const BYTE FAR* lpText, _LPCHAR_METRICS );
...
//	驱动程序接口函数
// *****************************************************************
static int SYSFont16_WordMask( HANDLE handle, LPCBYTE lpText, _LPCHAR_METRICS lpMask )
{
#ifdef EML_DOS
