...
static int SYSFont16_WordMask( HANDLE, const BYTE FAR* lpText, UINT len, _LPCHAR_METRICS );
...
// *****************************************************************
// 声明：static int SYSFont16_WordMask( HANDLE handle, const BYTE FAR* lpText, _LPCHAR_METRICS lpMask )
// 参数：
//	IN handle - 由 SYSFont16_CreateFont 返回的逻辑字体对象句柄
//	IN lpText - 文本指针
...
//	驱动程序接口函数
// *****************************************************************
static int SYSFont16_WordMask( HANDLE handle, LPCBYTE lpText, UINT len, _LPCHAR_METRICS lpMask )
{
#ifdef EML_DOS
   ...
   {	//ascii
       ...
       lpMask->bitmap.bmBits = (LPBYTE)(eng16Mask+_GET_ENGLISH( lpText )*16);//_ptrInRomEFont+ _GET_ENGLISH( lpText )*16;
