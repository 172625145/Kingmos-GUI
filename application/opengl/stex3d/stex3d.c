...
create3Dtexture(void)
{
   ...
   RETAILMSG(1, TEXT("creating 3d textures...\r\n"));
   voxels =
      (unsigned char *)
   ...
   RETAILMSG(1, TEXT("setting up 3d texture...\r\n"));
   ...
   RETAILMSG(1, TEXT("finished setting up 3d texture image.\r\n") );
